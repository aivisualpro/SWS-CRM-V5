      ...
      tasks: [
        {
          ...
          comments: [
            ...
            { id: 'cm-002', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Make sure we use `prefers-reduced-motion` media query for accessibility.', createdAt: new Date(Date.now() - 3 * 86400000).toISOString() },
          ],
        ...
        },
        {
          ...
          priority: 'medium',
          assignee: { id: 'u2', name: 'Yosi Nuri', avatar: '/avatars/adeel.png' },
        ...
        },
        {
          ...
          comments: [
            { id: 'cm-004', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Consider SSE (Server-Sent Events) as a simpler alternative for one-way updates.', createdAt: new Date(Date.now() - 6 * 86400000).toISOString() },
      ...
      tasks: [
        {
          ...
          comments: [
            ...
            { id: 'cm-008', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Found it — the count aggregation pipeline is missing the $match stage for category.', createdAt: new Date(Date.now() - 12 * 3600000).toISOString() },
          ],
      ...
      tasks: [
        {
          ...
          comments: [
            { id: 'cm-011', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Service account auth is working. Template placeholder replacement is done for header fields.', createdAt: new Date(Date.now() - 2 * 86400000).toISOString() },
            ...
            { id: 'cm-013', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Logo is doable. QR code will need a separate library — let me add a subtask for that.', createdAt: new Date(Date.now() - 8 * 3600000).toISOString() },
          ],
        ...
        },
        {
          ...
          comments: [
            ...
            { id: 'cm-016', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Nice! Make sure to add a 10MB file size limit on the client side.', createdAt: new Date(Date.now() - 1 * 86400000).toISOString() },
          ],
          createdAt: new Date(Date.now() - 5 * 86400000).toISOString(),
        },
      ],
      ...
      tasks: [
        {
          ...
          comments: [
            ...
            { id: 'cm-018', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Looks amazing! Just one thing — the modal backdrop needs to be slightly darker in light mode.', createdAt: new Date(Date.now() - 6 * 3600000).toISOString() },
          ],
        ...
        },
        {
          ...
          comments: [
            { id: 'cm-019', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Tested with 8,000 rows CSV — imports in ~4 seconds with client-side chunking.', createdAt: new Date(Date.now() - 2 * 86400000).toISOString() },
      ...
      tasks: [
        {
          ...
          comments: [
            { id: 'cm-023', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Project scaffolding complete. All base dependencies installed and configured.', createdAt: new Date(Date.now() - 28 * 86400000).toISOString() },
          ],
        ...
        },
        {
          ...
          comments: [
            { id: 'cm-027', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'useCrud<T> is fully generic and supports any entity type. Docs added inline.', createdAt: new Date(Date.now() - 16 * 86400000).toISOString() },
        ...
        },
        {
          ...
          comments: [
            ...
            { id: 'cm-030', author: 'Yosi Nuri', avatar: '/avatars/adeel.png', text: 'Custom domain SSL is active. Everything looks good in production.', createdAt: new Date(Date.now() - 8 * 86400000).toISOString() },
          ],
